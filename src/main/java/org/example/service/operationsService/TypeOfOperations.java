...
public enum TypeOfOperations {
    ...
    LASER_WELDING("СПЦФ трудочаса лазер_сварка"),
    ...
    // Монтажные работы
    ASSEMBLY_WORKER_HOURS("СПЦФ трудочаса рабочего монтаж"),
    COMPLEX_ASSEMBLY("СПЦФ трудочаса монтаж сложный"),
    ASSEMBLY_PR("СПЦФ ПР монтажные работы"),

    //Малярные работы
    PAINTING_WORKER_HOURS("СПЦФ трудочаса рабочего малярка"),
    POWDER_COATING("СПЦФ ПР нанесение порошковой краски"),
    POWDER_PRIMER("СПЦФ ПР нанесение порошкового грунта"),

    //Трубогиб
    BENDING("СПЦФ трудочаса трубогиб"),
    CNC_BENDING("СПЦФ ПР гиб на ЧПУ на трубогибе"),
