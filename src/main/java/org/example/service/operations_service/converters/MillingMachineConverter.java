...
public class MillingMachineConverter implements OperationConverter<MillingMachine> {
    ...
    public MillingMachine convert(Production production) {
        ...
        MillingMachine millingMachine = operationBuilderService.buildOperation(production, resource, getSupportedNomenclatures(), MillingMachine::new);

        operationSaverService.saveOperation(millingMachine);
